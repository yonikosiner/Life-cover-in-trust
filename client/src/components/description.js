  ...
  return (
    <DescriptionWrapper id="description">
      ...
      <DescribeWrapper>
        ...
        <DescribeCenter>
          <Describe>
            ...
            the surviving family members to replace lost income or to simply
            provide for a funeral.
          </Describe>
        </DescribeCenter>
        <DescribeCenter>
          <Describe>
            If you have an existing life insurance plan which is not interest,
            the proceeds will not be paid out immediately upon death and probate
            needs to take place, meaning when the monies are needed the most,
            the family may need to wait some months.
          </Describe>
        </DescribeCenter>
        <DescribeCenter>
          <Describe>
            Furthermore, the proceeds from life insurance are considered part of
            your estate. Under current legislation, 40% inheritance tax is
            charged on any assets higher than the Inheritance Tax allowance,
            meaning that your children may end up paying 40% tax on your life
            insurance.
          </Describe>
        </DescribeCenter>
        <DescribeCenter>
          <Describe>
            ...
            mortgage or for other things that the life insurance was there for
            in the first place.
          </Describe>
        </DescribeCenter>
      </DescribeWrapper>
      ...
      <DescribeWrapper>
        ...
        <DescribeCenter>
          <Describe>
            If Mr/Mrs A has life cover of £200,000 and it has not been written
            in trust, the £200,000 is added to his estate and if his estate is
            worth over the current threshold, Mr A’s children will need to wait
            for probate until receiving their money and they could potentially
            pay inheritance tax of £80,000 on this £200,000 alone, so the net
            payout will be somewhat less at £120,000.
          </Describe>
        </DescribeCenter>
      </DescribeWrapper>
      {/* Example two */}
      ...
      <DescribeWrapper>
        ...
        <DescribeCenter>
          <Describe>
            - Your beneficiaries will receive the proceeds from the life
      ...
      <DescribeWrapper>
        ...
        <DescribeCenter>
          <Describe>
            If you are worried that your existing life insurance plans are not
            in trust, we will be able to investigate this for you without charge
            and if amendments need to be made, we will be able to assist you to
            make any necessary changes and set up the trust, quickly and
            efficiently.
          </Describe>
        </DescribeCenter>
      </DescribeWrapper>
